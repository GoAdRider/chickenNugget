...
public class ExBoardDAOorigin {
	private Connection conn;
	private PreparedStatement ppst;
	private ResultSet rs;
	
	// 싱글톤
	private static ExBoardDAOorigin instance = new ExBoardDAOorigin();
	private ExBoardDAOorigin() {}
	public static ExBoardDAOorigin getInstance() {
		return instance;
	}
