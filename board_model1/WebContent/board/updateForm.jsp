...
<%
	...
	List<Map<String,Object>> board = manager.getBoard(no);
%>
		...
		<form action="update.jsp" method="post">
			...
			if(board!=null){
				for(int i=0;i<board.size();i++) {
					Map<String,Object> rmap = board.get(i);
			
			%>
			<table border="1">
				<tr>
					<td>이름</td>
					<td><input type="text" name="name" id="name" value="<%=rmap.get("NAME")%>"></td>
					<td>비밀번호</td>
				...
				<tr>
					...
					<td colspan="3"><input type="text" name="subject" id="subject"
						size="58" value="<%=rmap.get("SUBJECT")%>"></td>
				</tr>
				<tr>
					<td>내용</td>
					<td colspan="3">
						<pre><textarea rows="15" cols="60" name="content" id="content"><%=rmap.get("CONTENT") %></textarea></pre>
				<%}} %>
					</td>
				</tr>
				<tr align="center">
