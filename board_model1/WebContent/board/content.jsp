...
// 	ExBoardDTO board = manager.getBoard(no);
	List<Map<String,Object>> list = manager.getBoard(no);
...
<body>
	<center>
		...
		<table border="1" width="600">
			<tr>
				<td width="50">이름</td>
				<td width="250"><%=rmap.get("NAME") %></td>
				<td width="50">조회수</td>
				<td width="250"><%=rmap.get("READCOUNT") %></td>
			</tr>
			<tr>
				<td>제목</td>
				<td colspan="3"><%=rmap.get("SUBJECT") %></td>
			</tr>
			<tr>
				<td>내용</td>
				<td colspan="3"><pre><%=rmap.get("CONTENT") %></pre></td>
				<%} %>
			</tr>
			<tr align="center">
				<td colspan="4">
